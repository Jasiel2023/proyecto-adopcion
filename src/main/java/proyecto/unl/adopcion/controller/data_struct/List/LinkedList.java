package proyecto.unl.adopcion.controller.data_struct.List;
...
public class LinkedList<E> {
    ...
    protected E deleteFirst() throws ArrayIndexOutOfBoundsException {
        if (isEmpty()) {
    ...
    protected E deleteLast() throws ArrayIndexOutOfBoundsException {
        if (isEmpty()) {
            throw new ArrayIndexOutOfBoundsException("La lista se encuentra vacia");
        } else {
